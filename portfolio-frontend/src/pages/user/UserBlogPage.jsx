                    ...
                    <div className="relative w-full aspect-[16/9] overflow-hidden rounded-lg">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src =
                            "https://source.unsplash.com/random/800x400/?technology,design";
                        }}
                      />
                      <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-gray-900/30 to-transparent" />
                      {post.tags && (
